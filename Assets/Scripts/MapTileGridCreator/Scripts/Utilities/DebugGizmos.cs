...
namespace MapTileGridCreator.Utilities
{
	...
	public class FuncDebugGizmos
	{
		...
		public static void DebugCell(Core.Cell cell, Color color, float offsetSize = 0.01f)
		{
		...
		/// <param name="color">Color of the gizmo.</param>
		/// <param name="offsetSize"> The scale amount add to the grid size cell.</param>
		public static void DebugCells(List<Core.Cell> cells, Color color, float offsetSize = 0.01f)
		{
			foreach (Core.Cell cell in cells)
			{
