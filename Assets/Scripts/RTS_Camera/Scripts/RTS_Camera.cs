...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            zoomPos = (m_Transform.position.y - minHeight) / (maxHeight - minHeight);   // initial zoom view (to the preset camera height)
        }
        ...
        /// <summary>
        /// calcualte height (no auto-height adjustment)
        /// </summary>
        private void HeightCalculationV2()
        {
        ...
        private void LimitPosition()
        {
            ...
            m_Transform.position = new Vector3(Mathf.Clamp(m_Transform.position.x, centerX-limitX, centerX+limitX),
                m_Transform.position.y,
                Mathf.Clamp(m_Transform.position.z, centerY-limitY, centerY+limitY));
        }
